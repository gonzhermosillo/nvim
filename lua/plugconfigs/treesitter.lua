...
-- Defer Treesitter setup after first render to improve startup time of 'nvim 
-- {filename}'
vim.defer_fn(function()
	require('nvim-treesitter.configs').setup {
		...
		ignore_install = {},
		-- You can specify additional Treesitter modules here: -- For 
		-- example: -- playground = {--enable = true,-- },
		modules = {},
